...
function desenhar(){
    ...
    if (moduloLunar.posicao.y > canvas.height - moduloLunar.altura * 0.5){
        if(moduloLunar.velocidade.y <= 0.5 &&
            ...
            mostrarResutado("você pousou com sucesso!", cor = "green");
        } else {
            mostrarResutado("você impactou no solo!", cor = "red");
        }
        return
    }
...
function mostrarResutado(mensagem, cor){
